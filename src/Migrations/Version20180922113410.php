 ...
 */
final class Version20180922113410 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_crochet (user_id INT NOT NULL, crochet_id INT NOT NULL, INDEX IDX_20233E8A76ED395 (user_id), INDEX IDX_20233E87CB286DA (crochet_id), PRIMARY KEY(user_id, crochet_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
